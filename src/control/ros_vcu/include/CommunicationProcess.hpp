...
#include "ros_vcu/ecu_communicationParameters.h"
#include "STime.hpp"
#include "SLog.hpp"
...
private:
    ...
    //// rosparam handler
    ros_vcu::ecu_communicationParameters params_;
    dynamic_reconfigure::Server<ros_vcu::ecu_communicationConfig> reconfigSrv_;
    ...
    void reconfigureRequest(ros_vcu::ecu_communicationConfig &config, uint32_t level);
    void udpReceive();
    void udpSend();
    void timeCheck();
