...
class TraversableArea(genpy.Message):
  _md5sum = "482941e098397ea7b53454e6559ff9de"
...
float64 w
"""
  __slots__ = ['header','index','width','height','triD_submap_pose_image_index_x','triD_submap_pose_image_index_y','resolution','triD_submap_pose','cells','submap_finished_flag','valid']
  _slot_types = ['std_msgs/Header','int32','int32','int32','int32','int32','float64','geometry_msgs/Pose','uint8[]','bool','bool']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,index,width,height,triD_submap_pose_image_index_x,triD_submap_pose_image_index_y,resolution,triD_submap_pose,cells,submap_finished_flag,valid
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if type(_x) in [list, tuple]:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_2B().pack(_x.submap_finished_flag, _x.valid))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.submap_finished_flag, _x.valid,) = _get_struct_2B().unpack(str[start:end])
