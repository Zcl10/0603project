...
(cl:defmethod valid-val ((m <TraversableArea>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader iv_slam_ros_msgs-msg:valid-val is deprecated.  Use iv_slam_ros_msgs-msg:valid instead.")
  (valid m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<TraversableArea>)))
  ...
  "482941e098397ea7b53454e6559ff9de")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'TraversableArea)))
  "Returns md5sum for a message object of type 'TraversableArea"
  "482941e098397ea7b53454e6559ff9de")
