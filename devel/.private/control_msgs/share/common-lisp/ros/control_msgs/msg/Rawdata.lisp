...
(cl:defmethod cl:initialize-instance :after ((m <Rawdata>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Rawdata)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name control_msgs-msg:<Rawdata> is deprecated: use control_msgs-msg:Rawdata instead.")))

(cl:ensure-generic-function 'ros_time-val :lambda-list '(m))
(cl:defmethod ros_time-val ((m <Rawdata>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader control_msgs-msg:ros_time-val is deprecated.  Use control_msgs-msg:ros_time instead.")
  (ros_time m))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <Rawdata>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader control_msgs-msg:data-val is deprecated.  Use control_msgs-msg:data instead.")
  (data m))
