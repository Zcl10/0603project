...
#include <constrained_speed/cs_method2Config.h>
#else
struct cs_method2Config{};
#endif
...
struct cs_method2Parameters {

  using Config = cs_method2Config;

  cs_method2Parameters(const ros::NodeHandle& private_node_handle)
  : globalNamespace{"/"},
  ...
  friend std::ostream& operator<<(std::ostream& os, const cs_method2Parameters& p)
  {
