...
if("TRUE" STREQUAL "TRUE")
  set(waypoint_manager_SOURCE_PREFIX /home/bit2/0603_project/tang_ws/src/planning/waypoint_manager)
  set(waypoint_manager_DEVEL_PREFIX /home/bit2/0603_project/tang_ws/devel/.private/waypoint_manager)
  ...
  set(waypoint_manager_INSTALL_PREFIX /home/bit2/0603_project/tang_ws/install)
...
if(NOT "/home/bit2/0603_project/tang_ws/src/planning/waypoint_manager/include " STREQUAL " ")
  set(waypoint_manager_INCLUDE_DIRS "")
  set(_include_dirs "/home/bit2/0603_project/tang_ws/src/planning/waypoint_manager/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'waypoint_manager' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/bit2/0603_project/tang_ws/src/planning/waypoint_manager/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT waypoint_manager_NUM_DUMMY_TARGETS)
      set(waypoint_manager_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::waypoint_manager::wrapped-linker-option${waypoint_manager_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR waypoint_manager_NUM_DUMMY_TARGETS "${waypoint_manager_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::waypoint_manager::wrapped-linker-option${waypoint_manager_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND waypoint_manager_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/bit2/0603_project/tang_ws/devel/.private/waypoint_manager/lib;/home/bit2/0603_project/tang_ws/devel/lib;/opt/ros/kinetic/lib)
...
set(depends "roscpp;sensor_driver_msgs;lanelet_map_msgs;nav_msgs;opt_utils;anm_msgs;roslib;transform_tools;tinyspline_ros")
