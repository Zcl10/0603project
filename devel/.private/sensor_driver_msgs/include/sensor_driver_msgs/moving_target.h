...
#include <sensor_driver_msgs/Points.h>
#include <sensor_driver_msgs/History_traj.h>
#include <sensor_driver_msgs/Predict_traj.h>
...
struct moving_target_
{
  ...
  _history_num_type history_num;
   ...
   typedef std::vector< ::sensor_driver_msgs::History_traj_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::sensor_driver_msgs::History_traj_<ContainerAllocator> >::other >  _history_traj_type;
  _history_traj_type history_traj;

   typedef int32_t _predict_num_type;
  _predict_num_type predict_num;

   typedef std::vector< ::sensor_driver_msgs::Predict_traj_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::sensor_driver_msgs::Predict_traj_<ContainerAllocator> >::other >  _predict_traj_type;
...
struct MD5Sum< ::sensor_driver_msgs::moving_target_<ContainerAllocator> >
{
  ...
  {
    return "bd64b47561f1a3a021fb713900f96bd2";
  }

  static const char* value(const ::sensor_driver_msgs::moving_target_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xbd64b47561f1a3a0ULL;
  static const uint64_t static_value2 = 0x21fb713900f96bd2ULL;
};
...
struct Printer< ::sensor_driver_msgs::moving_target_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::sensor_driver_msgs::moving_target_<ContainerAllocator>& v)
  {
    ...
    for (size_t i = 0; i < v.history_traj.size(); ++i)
    {
      ...
      s << std::endl;
      s << indent;
      Printer< ::sensor_driver_msgs::History_traj_<ContainerAllocator> >::stream(s, indent + "    ", v.history_traj[i]);
    }
    ...
    for (size_t i = 0; i < v.predict_traj.size(); ++i)
    {
      ...
      s << std::endl;
      s << indent;
      Printer< ::sensor_driver_msgs::Predict_traj_<ContainerAllocator> >::stream(s, indent + "    ", v.predict_traj[i]);
    }
  }
};
