...
class GpswithHeading(genpy.Message):
  _md5sum = "4a10beb81941d6f823ae20ed309aa482"
...
uint16 service
"""
  __slots__ = ['header','gps','heading','roll','pitch','mode']
  _slot_types = ['std_msgs/Header','sensor_msgs/NavSatFix','float32','float32','float32','int32']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,gps,heading,roll,pitch,mode
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_B3fi().pack(_x.gps.position_covariance_type, _x.heading, _x.roll, _x.pitch, _x.mode))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.gps.position_covariance_type, _x.heading, _x.roll, _x.pitch, _x.mode,) = _get_struct_B3fi().unpack(str[start:end])
      return self
