...
if("TRUE" STREQUAL "TRUE")
  set(path_smoothing_SOURCE_PREFIX /home/bit2/0603_project/tang_ws/src/planning/path_smoothing)
  set(path_smoothing_DEVEL_PREFIX /home/bit2/0603_project/tang_ws/devel/.private/path_smoothing)
  ...
  set(path_smoothing_INSTALL_PREFIX /home/bit2/0603_project/tang_ws/install)
...
if(NOT "/home/bit2/0603_project/tang_ws/devel/.private/path_smoothing/include;/home/bit2/0603_project/tang_ws/src/planning/path_smoothing/include;/usr/local/include;/usr/include/eigen3;/usr/include;/usr/local/lib/cmake/casadi/../../../include " STREQUAL " ")
  set(path_smoothing_INCLUDE_DIRS "")
  set(_include_dirs "/home/bit2/0603_project/tang_ws/devel/.private/path_smoothing/include;/home/bit2/0603_project/tang_ws/src/planning/path_smoothing/include;/usr/local/include;/usr/include/eigen3;/usr/include;/usr/local/lib/cmake/casadi/../../../include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'path_smoothing' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/bit2/0603_project/tang_ws/src/planning/path_smoothing/${idir}'.  ${_report}")
    endif()
    _list_append_unique(path_smoothing_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "path_smoothing;ncopt_lib;/usr/local/lib/libceres.so.1.12.0;/usr/local/lib/libcasadi.so.3.5")
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT path_smoothing_NUM_DUMMY_TARGETS)
      set(path_smoothing_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::path_smoothing::wrapped-linker-option${path_smoothing_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR path_smoothing_NUM_DUMMY_TARGETS "${path_smoothing_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::path_smoothing::wrapped-linker-option${path_smoothing_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND path_smoothing_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/bit2/0603_project/tang_ws/devel/.private/path_smoothing/lib;/home/bit2/0603_project/tang_ws/devel/lib;/opt/ros/kinetic/lib)
...
set(depends "rosparam_handler;dynamic_reconfigure;grid_map_core;voronoi;tinyspline_ros")
