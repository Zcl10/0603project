...
class ReportCylinderPosition {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.uint16(obj.left_one, buffer, bufferOffset);
    // Serialize message field [left_two]
    bufferOffset = _serializer.uint16(obj.left_two, buffer, bufferOffset);
    // Serialize message field [left_three]
    bufferOffset = _serializer.uint16(obj.left_three, buffer, bufferOffset);
    // Serialize message field [left_four]
    bufferOffset = _serializer.uint16(obj.left_four, buffer, bufferOffset);
    // Serialize message field [right_one]
    bufferOffset = _serializer.uint16(obj.right_one, buffer, bufferOffset);
    // Serialize message field [right_two]
    bufferOffset = _serializer.uint16(obj.right_two, buffer, bufferOffset);
    // Serialize message field [right_three]
    bufferOffset = _serializer.uint16(obj.right_three, buffer, bufferOffset);
    // Serialize message field [right_four]
    bufferOffset = _serializer.uint16(obj.right_four, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ReportCylinderPosition(null);
    // Deserialize message field [left_one]
    data.left_one = _deserializer.uint16(buffer, bufferOffset);
    // Deserialize message field [left_two]
    data.left_two = _deserializer.uint16(buffer, bufferOffset);
    // Deserialize message field [left_three]
    data.left_three = _deserializer.uint16(buffer, bufferOffset);
    // Deserialize message field [left_four]
    data.left_four = _deserializer.uint16(buffer, bufferOffset);
    // Deserialize message field [right_one]
    data.right_one = _deserializer.uint16(buffer, bufferOffset);
    // Deserialize message field [right_two]
    data.right_two = _deserializer.uint16(buffer, bufferOffset);
    // Deserialize message field [right_three]
    data.right_three = _deserializer.uint16(buffer, bufferOffset);
    // Deserialize message field [right_four]
    data.right_four = _deserializer.uint16(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ReportCylinderPosition(null);
...
module.exports = ReportCylinderPosition;
