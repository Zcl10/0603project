...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Regulatory>)))
  ...
  "9816e0dc9bd5857a27ef753c7306697f")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Regulatory)))
  "Returns md5sum for a message object of type 'Regulatory"
  "9816e0dc9bd5857a27ef753c7306697f")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Regulatory>)))
  ...
  (cl:format cl:nil "Node[] special_nodes~%Way[] special_ways~%~%================================================================================~%MSG: lanelet_map_msgs/Node~%int32 id~%string type~%float64 vlimit~%geometry_msgs/Point point~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: lanelet_map_msgs/Way~%string task_area~%int8 is_forward~%int8 open_concave_obs_det~%int8 open_dynamic_obs_det~%int8 open_foggy_det~%int8 open_water_det~%int8 foggy_area~%int8 lawn_area~%int8 water_area~%int8 wall_area~%int8 ditch_area~%float64 vel_limit~%Node[] points~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Regulatory)))
  "Returns full string definition for message of type 'Regulatory"
  (cl:format cl:nil "Node[] special_nodes~%Way[] special_ways~%~%================================================================================~%MSG: lanelet_map_msgs/Node~%int32 id~%string type~%float64 vlimit~%geometry_msgs/Point point~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: lanelet_map_msgs/Way~%string task_area~%int8 is_forward~%int8 open_concave_obs_det~%int8 open_dynamic_obs_det~%int8 open_foggy_det~%int8 open_water_det~%int8 foggy_area~%int8 lawn_area~%int8 water_area~%int8 wall_area~%int8 ditch_area~%float64 vel_limit~%Node[] points~%~%~%"))
