...
(cl:ensure-generic-function 'wall_area-val :lambda-list '(m))
(cl:defmethod wall_area-val ((m <Way>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lanelet_map_msgs-msg:wall_area-val is deprecated.  Use lanelet_map_msgs-msg:wall_area instead.")
  (wall_area m))

(cl:ensure-generic-function 'ditch_area-val :lambda-list '(m))
(cl:defmethod ditch_area-val ((m <Way>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lanelet_map_msgs-msg:ditch_area-val is deprecated.  Use lanelet_map_msgs-msg:ditch_area instead.")
  (ditch_area m))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <Way>) ostream)
  ...
  (cl:let* ((signed (cl:slot-value msg 'wall_area)) (unsigned (cl:if (cl:< signed 0) (cl:+ signed 256) signed)))
    (cl:write-byte (cl:ldb (cl:byte 8 0) unsigned) ostream)
    )
  (cl:let* ((signed (cl:slot-value msg 'ditch_area)) (unsigned (cl:if (cl:< signed 0) (cl:+ signed 256) signed)))
    (cl:write-byte (cl:ldb (cl:byte 8 0) unsigned) ostream)
    )
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Way>) istream)
  "Deserializes a message object of type '<Way>"
    ...
    (cl:let ((unsigned 0))
      (cl:setf (cl:ldb (cl:byte 8 0) unsigned) (cl:read-byte istream))
      (cl:setf (cl:slot-value msg 'wall_area) (cl:if (cl:< unsigned 128) unsigned (cl:- unsigned 256))))
    (cl:let ((unsigned 0))
      (cl:setf (cl:ldb (cl:byte 8 0) unsigned) (cl:read-byte istream))
      (cl:setf (cl:slot-value msg 'ditch_area) (cl:if (cl:< unsigned 128) unsigned (cl:- unsigned 256))))
    (cl:let ((bits 0))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Way>)))
  ...
  "99ad0e5a81672247ed85801fdca6b0a2")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Way)))
  "Returns md5sum for a message object of type 'Way"
  "99ad0e5a81672247ed85801fdca6b0a2")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Way>)))
  ...
  (cl:format cl:nil "string task_area~%int8 is_forward~%int8 open_concave_obs_det~%int8 open_dynamic_obs_det~%int8 open_foggy_det~%int8 open_water_det~%int8 foggy_area~%int8 lawn_area~%int8 water_area~%int8 wall_area~%int8 ditch_area~%float64 vel_limit~%Node[] points~%~%================================================================================~%MSG: lanelet_map_msgs/Node~%int32 id~%string type~%float64 vlimit~%geometry_msgs/Point point~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Way)))
  "Returns full string definition for message of type 'Way"
  (cl:format cl:nil "string task_area~%int8 is_forward~%int8 open_concave_obs_det~%int8 open_dynamic_obs_det~%int8 open_foggy_det~%int8 open_water_det~%int8 foggy_area~%int8 lawn_area~%int8 water_area~%int8 wall_area~%int8 ditch_area~%float64 vel_limit~%Node[] points~%~%================================================================================~%MSG: lanelet_map_msgs/Node~%int32 id~%string type~%float64 vlimit~%geometry_msgs/Point point~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%~%"))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <Way>))
  ...
  (cl:list 'Way
    ...
    (cl:cons ':wall_area (wall_area msg))
    (cl:cons ':ditch_area (ditch_area msg))
