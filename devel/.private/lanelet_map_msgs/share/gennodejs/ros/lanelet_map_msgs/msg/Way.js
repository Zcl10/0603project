...
class Way {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('wall_area')) {
        this.wall_area = initObj.wall_area
      }
      else {
        this.wall_area = 0;
      }
      if (initObj.hasOwnProperty('ditch_area')) {
        this.ditch_area = initObj.ditch_area
      }
      else {
        this.ditch_area = 0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [wall_area]
    bufferOffset = _serializer.int8(obj.wall_area, buffer, bufferOffset);
    // Serialize message field [ditch_area]
    bufferOffset = _serializer.int8(obj.ditch_area, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [wall_area]
    data.wall_area = _deserializer.int8(buffer, bufferOffset);
    // Deserialize message field [ditch_area]
    data.ditch_area = _deserializer.int8(buffer, bufferOffset);
  ...
  static md5sum() {
    ...
    return '99ad0e5a81672247ed85801fdca6b0a2';
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.wall_area !== undefined) {
      resolved.wall_area = msg.wall_area;
    }
    else {
      resolved.wall_area = 0
    }

    if (msg.ditch_area !== undefined) {
      resolved.ditch_area = msg.ditch_area;
    }
    else {
      resolved.ditch_area = 0
    }
