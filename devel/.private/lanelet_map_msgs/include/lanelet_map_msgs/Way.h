...
struct Way_
{
  ...
  _water_area_type water_area;
   ...
   typedef int8_t _wall_area_type;
  _wall_area_type wall_area;

   typedef int8_t _ditch_area_type;
  _ditch_area_type ditch_area;
...
// {'geometry_msgs': ['/opt/ros/kinetic/share/geometry_msgs/cmake/../msg'], 'lanelet_map_msgs': ['/home/bit2/0603_project/tang_ws/src/msgs/lanelet_map_msgs/msg'], 'std_msgs': ['/opt/ros/kinetic/share/std_msgs/cmake/../msg']}
...
struct MD5Sum< ::lanelet_map_msgs::Way_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0x99ad0e5a81672247ULL;
  static const uint64_t static_value2 = 0xed85801fdca6b0a2ULL;
};
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::lanelet_map_msgs::Way_<ContainerAllocator> >
  {
    template<typename Stream, typename T> inline static void allInOne(Stream& stream, T m)
    {
      ...
      stream.next(m.wall_area);
      stream.next(m.ditch_area);
...
struct Printer< ::lanelet_map_msgs::Way_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::lanelet_map_msgs::Way_<ContainerAllocator>& v)
  {
    ...
    s << indent << "wall_area: ";
    Printer<int8_t>::stream(s, indent + "  ", v.wall_area);
    s << indent << "ditch_area: ";
    Printer<int8_t>::stream(s, indent + "  ", v.ditch_area);
    s << indent << "vel_limit: ";
