...
if(NOT "include;/usr/local/include;/usr/include/eigen3;/usr/include;/usr/local/lib/cmake/casadi/../../../include " STREQUAL " ")
  set(path_smoothing_INCLUDE_DIRS "")
  set(_include_dirs "include;/usr/local/include;/usr/include/eigen3;/usr/include;/usr/local/lib/cmake/casadi/../../../include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'path_smoothing' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '\${prefix}/${idir}'.  ${_report}")
    endif()
